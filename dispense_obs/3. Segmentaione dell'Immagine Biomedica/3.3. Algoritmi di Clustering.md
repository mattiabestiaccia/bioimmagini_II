...
> [!nav] Navigazione
> 
[[3.2. Fondamenti Machine Learning|← Fondamenti ML]] | [[0. INDICE|📑]] | [[3.4. Segmentazione Regioni e Contorni|Regioni e Contorni →]]

## 3.3.1 Segmentazione a Soglia (_Thresholding_)
...
### 3.3.1.1 Meccanismo e Applicazione
...
![[Pasted image 20260104192756.png]]
### 3.3.1.2 Limiti Fondamentali della Segmentazione a Soglia
...
### 3.3.1.3 Soluzioni e Approcci Correttivi
...
### 3.3.2.1 Principio di Ottimizzazione
...
#### 3.3.2.1.1 Varianza Intra-Classe e Inter-Classe
...
dove:
- $\omega_i(t)$ è la probabilità (o peso) di una classe $i$ separata dall'altra dalla soglia $t$.
...
### 3.3.2.2 Implementazione Algoritmica (Ricerca Esaustiva)
...
2. **Calcolo della Varianza per Ogni $t$:** Per ogni soglia $t$ (da $0$ al massimo livello di grigio) si calcolano i pesi e le medie delle due classi:
    ...
    ![[Pasted image 20260104193335.png]]
...
### 3.3.2.3 Efficienza e Considerazioni Finali
...
## 3.3.3 Introduzione al Clustering
...
![[Pasted image 20251129202811.png]]

![[Pasted image 20251129202820.png]]

### 3.3.3.1 Classificazione degli Algoritmi di Clustering
...
## 3.3.4 Algoritmo K-means per il Clustering
...
### 3.3.4.1 Funzione Obiettivo e Complessità
...
### 3.3.4.2 Procedura Iterativa K-means
...
#### 3.3.4.2.1 Dipendenza dalle Condizioni Iniziali

L'algoritmo **converge sempre**, ma la configurazione finale non è garantita essere il **minimo assoluto**. Poiché l'algoritmo K-means è un **ottimizzatore locale**, lo stato di convergenza dipende dalla definizione iniziale dei centroidi.
...
### 3.3.4.3 Aspetti Implementativi e Difficoltà
...
### 3.3.4.4 Applicazione alla Segmentazione di Immagini
...
## 3.3.5 Clustering Non Esclusivo (FCM)
...
### 3.3.5.1 Fondamenti Teorici: Logica Fuzzy
...
### 3.3.5.2 Funzione Obiettivo e Parametro Fuzzyness
...
### 3.3.5.3 Aggiornamento Iterativo
...
### 3.3.5.4 Rilevanza Clinica: Gestione del PVE
...
## 3.3.6 Algoritmo EM (Expectation Maximization)
...
### 3.3.6.1 L'Approccio Basato su Modelli
...
### 3.3.7.1 Esempio Pratico: Single-Linkage
...
### 3.3.8.3 Importanza della Normalizzazione
