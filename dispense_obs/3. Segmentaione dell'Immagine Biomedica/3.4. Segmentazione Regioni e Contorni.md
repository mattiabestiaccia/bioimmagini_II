...
> [!nav] Navigazione
> 
[[3.3. Algoritmi di Clustering|← Clustering]] | [[0. INDICE|📑]] | [[4. Validazione degli Algoritmi di Analisi dell'Immagine/4.1. Intro|Validazione →]]


## 3.4.1 Algoritmi di Labeling (Etichettatura di Regioni)
...
### 3.4.1.2 Funzionamento dell'Algoritmo di Labeling
...
## 3.4.2 Region Growing (Crescita di Regione)
...
### 3.4.2.2 Criteri di Similarità e Soglia ($T$)

#### 3.4.2.2.1 Immagini Binarie
...
## 3.4.3 Segmentazione a Contorni
...
### 3.4.3.1 Rilevamento dei Contorni
...
### 3.4.3.2 Collegamento dei Contorni (Algoritmo di Canny)
...
### 3.4.4.3 Modelli Region-Based (Chan-Vese)
...
## 3.4.5 Level Set (Contorno Attivo Implicito)
...
### 3.4.5.1 Equazione di Evoluzione
...
![[Pasted image 20260105160625.png]]
![[Pasted image 20260105160745.png]]
![[Pasted image 20260105160929.png]]
...
![[Pasted image 20260105161027.png]]

Mappe per $th=200$, $th=500$, $th=650$, $th=1900$.

![[Pasted image 20260105161037.png]]
...
> **NOTA**:  I metodi classici descritti in questa sezione possono essere confrontati con gli approcci basati su **Deep Learning**:
