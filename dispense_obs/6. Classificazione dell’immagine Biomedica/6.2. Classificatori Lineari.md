...
> [!nav] Navigazione
> [[6.1. Intro Classificazione|← Introduzione]] | [[0. INDICE|📑]] | [[6.3. Fondamenti Reti Neurali|Reti Neurali →]]

# Classificatori Lineari

## 6.2.1 Nearest Neighbor Classifier (NNC)

L'esempio più semplice di classificatore è il **Nearest Neighbor Classifier (NNC)**.

### 6.2.1.1 Funzionamento
...
## 6.2.2 k-Nearest Neighbor Classifier (k-NN)
...
### 6.2.5.3 Interpretazione Probabilistica
...
### 6.2.6.2 Derivata Numerica (Differenze Finite)

$$\frac{dy}{dx} \approx \frac{y(x + \Delta x) - y(x - \Delta x)}{2\Delta x}$$

### 6.2.6.3 Gradient Descent Multidimensionale
...
### 6.2.6.4 Varianti del Gradient Descent
...
## 6.2.7 Esempio MATLAB: Classificatore Softmax
