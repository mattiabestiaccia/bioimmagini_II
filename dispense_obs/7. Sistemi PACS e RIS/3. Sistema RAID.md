...
> [!nav]- Navigazione
> **Precedente:** [[2. Componenti PACS|← Componenti PACS]] | [[../0. INDICE|📑 Indice]] | **Successivo:** [[4. Backup e Stampanti|Backup e Stampanti →]]
...
## Principio di Funzionamento: Controllo di Parità
...
## Fattori per la Scelta del RAID

| Fattore | Considerazione |
|---------|----------------|
| **Numero dischi** | Determinato dalla quantità di dati. Probabilità rottura = N × p |
