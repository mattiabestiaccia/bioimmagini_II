...
> [!nav]- Navigazione
> **Precedente:** [[3. Computer Vision e Analisi dell'Immagine Biomedica|← Computer Vision]] | [[0. INDICE|📑 Indice]] | **Successivo:** [[5. Qualità dell'immagine Biomedica|Qualità Immagine →]]
...
>
> **Argomenti correlati:**
> - [[5. Qualità dell'immagine Biomedica|Qualità dell'Immagine]] (applica i concetti di rumore e PVE)
...
**Causa:** il processo di acquisizione è discreto → il segnale viene acquisito in un volume finito di spazio.
...
Convoluzione con kernel gaussiano $h(x,y)$ → operazione di **smoothing** dei contorni
...
**Cause per modalità:**
- **MRI:** disomogeneità campo magnetico statico o sensibilità bobine
...
**Problema di stima:**
Stimare $I_0(x,y)$ conoscendo solo $I(x,y)$ → problema **fortemente indeterminato**
...
- Esempio: immagine a 6 pattern → 6 picchi distinti
...
**Distribuzione di $p$:**
In immagini biomediche reali, $p$ si può considerare distribuito **uniformemente** (griglia di acquisizione e forma oggetto non hanno relazione particolare)
...
**Dipendenza dalla risoluzione:**
L'incidenza del PVE diminuisce con pixel più piccoli (migliore risoluzione)
