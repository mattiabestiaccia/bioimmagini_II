...
> [!nav]- Navigazione
> **Precedente:** [[2. Interpolazione, Filtraggio e Compressione/1. Intro|← Introduzione Preprocessing]] | [[0. INDICE|📑 Indice]] | **Successivo:** [[3. Filtraggio|Filtraggio →]]
...
A parità di FOV (Field of View), migliore risoluzione spaziale → pixel più piccoli → immagine di dimensioni maggiori
...
### Quando è Necessaria l'Interpolazione
...
**Aumento risoluzione:**
Se vogliamo raddoppiare la risoluzione (es. 512×512), dobbiamo:
...
**Interattività:**
- L'origine dei tre piani può essere definita interattivamente
- L'operatore può esplorare il volume dei dati
